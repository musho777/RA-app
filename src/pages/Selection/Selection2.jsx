...
export const Selection2 = ({ navigation }) => {
    return <View >
        <ImageBackground source={require('../../assets/img/2.png')} resizeMode="cover" style={styles.image}>
            <View style={{ transform: [{ rotate: '90deg' }], marginTop: -100, }}>
                <TouchableOpacity onPress={() => navigation.navigate('Level2_4')}>
                    <Image style={styles.img} source={require('../../assets/img/4_1.png')} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('Level2_3')}>
                    <Image style={styles.img} source={require('../../assets/img/3_1.png')} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('Level2_2')}>
                    <Image style={styles.img} source={require('../../assets/img/2_1.png')} />
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('Level2_1')}>
