...
export const Level11_6 = ({ navigation }) => {
    const [side1, setSide1] = useState([
        [
            ...
            [
                { icone: <Image style={{ width: 50, height: 70 }} source={require('../../assets/img/level11/game6/воздзмей1право.png')} />, id: 4, active: false },
                { icone: <Image style={{ width: 50, height: 70 }} source={require('../../assets/img/level11/game6/воздзмей2право.png')} />, id: 5, active: false },
                { icone: <Image style={{ width: 50, height: 70 }} source={require('../../assets/img/level11/game6/воздзмей3право.png')} />, id: 6, active: false }
            ]
        ],
        [
            [
